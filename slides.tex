...
\frame{\frametitle{Wie kann ich Go lernen?}
  {\bf Computergegner}
  \begin{itemize}
    \item GnuGo / Kigo (Linux)
    \item Igowin (Windows)
    \item Go Free (Android / iOS)
    \item Leela (Windows / Linux)
  \end{itemize}

  {\bf online spielen}
  \begin{itemize}
    \item GoQuest (App / Browser): 9x9, minimalistisch
    \item OGS (\url{online-go.com}): alle Brettgrößen u. Zeitlimits
  \end{itemize} 

  {\bf Taktik üben}
  \begin{itemize}
    \item \url{goproblems.com}
    \item \url{gochild2009.appspot.com}
  \end{itemize} 
}
